<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardUser.aspx.cs" Inherits="HospitalSystem.DashboardUser" %>
...
<body class="bodyuser">
    ...
    <div class="uppanel">
        ...
        <p id="h3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
            ...
            <asp:Button ID="Btn_Apointment" runat="server" CssClass="apointment" Text="Make an Appointment" OnClick="Btn_Apointment_Click" />
            <asp:Button ID="Btn_doctor" runat="server" CssClass="doctor" Text="View Doctor" OnClick="Btn_doctor_Click" />
    </form>
        </body>
</html>
